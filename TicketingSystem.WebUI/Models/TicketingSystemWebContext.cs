...
namespace TicketingSystem.WebUI.Models
{
    public class TicketingSystemWebContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<TicketingSystem.Core.Team> Teams { get; set; }

        public System.Data.Entity.DbSet<TicketingSystem.Core.Project> Projects { get; set; }
    }
}