...
namespace TicketingSystem.WebUI.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,CreatedOn,ModifiedOn")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,CreatedOn,ModifiedOn")] Team team)
        {
            if (ModelState.IsValid)
            {
