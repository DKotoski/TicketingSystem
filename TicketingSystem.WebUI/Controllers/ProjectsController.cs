...
namespace TicketingSystem.WebUI.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,CreatedOn,ModifiedOn")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,CreatedOn,ModifiedOn")] Project project)
        {
            if (ModelState.IsValid)
            {
